...
namespace dc {
  ...
  /**
     ...
     There are 3 kinds of degradation spots: independent spots, overlapping spots and disconnection spots.
     ...
     @param level quantity of degradation, in [0; 10]. The number of degradation spots will be determined according to number of connected components in image. The higher the level, the higher the number of degradation spots.
  ...
  */
    extern FRAMEWORK_EXPORT cv::Mat degradation(const cv::Mat &img, int level = 1,
						float indepentSpotsRatio = 0.33f, float overlappingSpotsRatio = 0.33);
